...
public class TestConfig implements Serializable {
    ...
    public static TestConfig loadFromEnvironment() {
        return TestConfig
                ...
                .numberOfTracers(getIntegerEnv("NUMBER_OF_TRACERS", "50"))
                .numberOfSpans(getIntegerEnv("NUMBER_OF_SPANS", "100"))
                .reportSpansDuration(getStringEnv("REPORT_SPANS_DURATION", "4h"))
                ...
                .jaegerCollectorHost(getStringEnv("JAEGER_COLLECTOR_HOST", "jaeger-clickhouse-collector.observability"))
